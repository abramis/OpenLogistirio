...
const capabilities: Capability[] = [
  ...
  },
  {
    ...
    icon: 'receipt_long',
    status: 'Production με ελεγχόμενες αποστολές',
    items: [
  ...
  {
    title: 'Μισθοδοσία & ΕΡΓΑΝΗ ΙΙ',
    icon: 'badge',
    status: 'Production 2026',
    items: [
      'Μισθοδοσία, δώρα, άδειες, ασθένεια, αποχωρήσεις και ΑΠΔ',
      'Έναρξη και μεταβολές εργασιακής σχέσης με νόμιμες προθεσμίες',
      'Πραγματικό πρωτόκολλο και αποδεικτικό αποδοχής εργαζομένου',
      'Φραγμός μισθοδοσίας όταν εκκρεμεί υποχρεωτική δήλωση',
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      'Ειδικές ΣΣΕ και αυτόματη υποβολή στο ΕΡΓΑΝΗ ΙΙ',
