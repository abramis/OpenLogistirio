...
- Γραπτή λίστα γνωστών περιορισμών: η μισθοδοσία καλύπτει τον κύκλο 2026,
  δώρα/επίδομα αδείας, ασθένεια, οικογενειακές άδειες, νυχτερινά,
  Κυριακές/αργίες, υπερεργασία/υπερωρίες, βιβλίο αδειών, αποζημίωση απόλυσης,
  ειδικές εγγραφές και fixed-width ΑΠΔ, αλλά όχι ακόμη αυτόματη επιλογή
  ειδικών ΣΣΕ, αυτόματη υποβολή στο ΕΡΓΑΝΗ ΙΙ ή πλήρη TAXISnet/ΓΓΠΣ ροή.
